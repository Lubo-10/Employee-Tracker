...
<h1 align="center">Welcome to Employee Tracker Application👋</h1>
<p>
  <img alt="Version" src="https://img.shields.io/badge/version-1.0.0-blue.svg?cacheSeconds=2592000" />
  <a href="https://github.com/Brainybrian316/Employee-Trackerr#readme" target="_blank">
    <img alt="Documentation" src="https://img.shields.io/badge/documentation-yes-brightgreen.svg" />
  </a>
  <a href="https://github.com/Brainybrian316/Employee-Tracker/graphs/commit-activity" target="_blank">
...
> A backend development application that creates an interface that will allow non-developers to easily view and interact with information stored in databases(CMS). This is a command line application to manage a company's employees database using Node.js, Inquirer, and MySQL.
